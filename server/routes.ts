...
export async function registerRoutes(
  ...
  app.get("/sitemap.xml", (_req, res) => {
    ...
    const pages = [{ loc: "/", priority: "1.0", changefreq: "weekly", lastmod: today }, { loc: "/betaalbare-professionele-website", priority: "0.9", changefreq: "monthly", lastmod: today }, { loc: "/blog", priority: "0.8", changefreq: "weekly", lastmod: today }, { loc: "/offerte", priority: "0.8", changefreq: "monthly", lastmod: "2026-06-01" }, { loc: "/werkwijze", priority: "0.7", changefreq: "monthly", lastmod: today }, { loc: "/consentease", priority: "0.6", changefreq: "monthly", lastmod: today }, { loc: "/privacy", priority: "0.3", changefreq: "yearly", lastmod: "2026-03-01" }, { loc: "/terms", priority: "0.3", changefreq: "yearly", lastmod: "2026-03-01" }, ...getAllBlogArticles().map((a) => ({ loc: `/blog/${a.slug}`, priority: "0.7", changefreq: "monthly", lastmod: a.dateModified ?? a.datePublished }))];
