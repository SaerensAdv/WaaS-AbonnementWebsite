  ...
  app.get("/sitemap.xml", async (_req, res) => {
    ...
    try {
      ...
      const staticPages = [
        ...
        { url: "/vergelijk", priority: "0.8", changefreq: "monthly" },
        { url: "/vergelijk/wordpress", priority: "0.7", changefreq: "monthly" },
        { url: "/vergelijk/wix", priority: "0.7", changefreq: "monthly" },
        { url: "/vergelijk/eenmalig", priority: "0.7", changefreq: "monthly" },
