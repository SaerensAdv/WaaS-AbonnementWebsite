...
const sections = [
  ...
  },
  {
    ...
    content: [
      "3.1. Dienstverlener biedt drie abonnementsvormen aan:",
      "• **Starter** (€49/maand) — tot 5 pagina's, 1 revisieronde bij oplevering, €20 maandelijks wijzigingscredits.",
      "• **Professional** (€99/maand) — tot 10 pagina's, 2 revisierondes bij oplevering, €40 maandelijks wijzigingscredits.",
      "• **Business** (€199/maand) — tot 20 pagina's, 2 revisierondes bij oplevering, €80 maandelijks wijzigingscredits.",
      "3.2. Alle abonnementen zijn inclusief: op maat gemaakt design, responsive (mobiel-vriendelijk) ontwikkeling, beheerde hosting, SSL-certificaat, onderhoud, beveiligingsupdates, cookie banner (ConsentEase) en support.",
      "3.3. Er zijn geen opstartkosten verbonden aan het afsluiten van een Abonnement.",
      "3.4. De exacte inhoud en features per plan staan beschreven op de website van Dienstverlener en kunnen van tijd tot tijd worden bijgewerkt.",
    ],
  },
  {
    id: "looptijd",
  ...
  },
  {
    ...
    content: [
      ...
      "5.4. Na oplevering van het eerste ontwerp heeft de Klant recht op het aantal revisierondes dat bij het gekozen plan hoort (Starter: 1 ronde, Professional en Business: 2 rondes). Aanvullende revisierondes worden als extra wijzigingen verrekend via het credits-systeem.",
  ...
  },
  {
    ...
    content: [
      "6.1. Elk Abonnement bevat een maandelijks wijzigingsbudget (Credits):",
      "• Starter: €20 per maand",
      "• Professional: €40 per maand",
      "• Business: €80 per maand",
      ...
      "• Uitbreiding van het aantal pagina's boven het limiet van het gekozen plan;",
  ...
  },
  {
    ...
    content: [
      "8.1. Naast het Abonnement kan de Klant aanvullende Add-ons afnemen, waaronder maar niet beperkt tot: Google Ads Beheer, Meta Ads Beheer, Social Media Beheer, E-commerce Module, Extra Content Wijzigingen en Booking/Reserveringssysteem.",
