...
export default function HomePage() {
  ...
  useSEO({
    ...
    absoluteTitle: true,
    description: "Professionele website voor €69/maand: design, hosting, onderhoud en 2 wijzigingscredits inbegrepen. Voor starters en zelfstandigen in NL en België.",
    canonical: "/",
